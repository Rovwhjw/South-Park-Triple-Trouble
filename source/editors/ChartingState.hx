...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Character', "Value 1: Character to change (Dad, BF, GF)\nValue 2: New character's name"],
                ['HealthDrain', "Drains players health when opponent sings At a specific time. Value 1: How much health to drain when opponent sings (0.5 recommended)/nValue 2: Lowest Health Possible From Drain (0.01 recommened)"]
	];
